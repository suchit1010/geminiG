...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BAIh4B11.js
...
var styles_default = "/assets/styles-BSOehIrG.css";
var APP_NAME = "Gauntlet";
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Gauntlet is a work agent for everyone. Drop a messy job. It plans, builds, and criticizes itself until the work is done."
			},
			{
				name: "theme-color",
				content: "#0b0c0b"
...
var $$splitComponentImporter$1 = () => import("./routes-DuY3wngg.mjs");
var Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./mission._id-BCQQ1c9F.mjs");
var Route = createFileRoute("/mission/$id")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
