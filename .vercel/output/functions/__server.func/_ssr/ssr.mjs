...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DzOPt8I1.mjs");
...
var manifest = { "3d85df9ddc6867ebfe876e8c66dbefb0a411172dad05dfd4acef1bcb95f1e9c1": {
	functionName: "runGauntletRound_createServerFn_handler",
	importer: () => import("./run-round-D6facfYC.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BAIh4B11.mjs").then((n) => n.t),
