...
- **`GEMINI_API_KEY` in the env** = real, server-only Google Gemini API access
  (Gemini 2.0 Flash / Pro): read **`gemini-api`** first, keep calls user-initiated and
  structured, utilize multimodal capabilities.
